...
plugins=(k tig git gitfast colored-man-pages colorize command-not-found cp dirhistory autojump zsh-completions fast-syntax-highlighting zsh-autosuggestions)
